...
const auxillaryResponses = { 
  ...
  "name": "USA", 
  "responses": [
    { "signal": 1, "response": "Hello, and welcome to the most wonderful and greatest tariff game in the world. Trumps Tariff's. Lets get this trade war started, first you just need to grab 'em right by the.... sorry I mean, click the start button, or on the countries and add some tariffs." },
